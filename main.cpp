...
int main() {
	...
	Plan right(new Phong(glm::vec3(0.733f, 0.000f, 0.117f), glm::vec3(0.0f, 0.6f, 0.0f), 128.0f, 0.5f), glm::vec3(-10.0f, 0.0f, 0.0f),
			   glm::vec3(1.0f, 0.0f, 0.0f));
	Plan floor(new Phong(glm::vec3(0.360f, 0.266f, 0.980f), glm::vec3(0.4f, 0.2f, 0.0f), 128.f, 0.5f), glm::vec3(0.0f, -10.0f, 0.0f),
			   glm::vec3(0.0f, 1.0f, 0.0f));
	Plan closedBox(new Phong(glm::vec3(0.0f, 0.0f, 1.0f), glm::vec3(1.0f, 0.0f, 0.0f), 128.0f, 1.f), glm::vec3(0.0f, 0.0f, -10.0f),
				   glm::vec3(0.0f, 0.0f, 1.0f));
