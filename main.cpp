...
int main() {
	...
	Sphere sphere(new Phong(false, glm::highp_dvec3(0.1, 0.2, 0.1), glm::highp_dvec3(0.6, 0.0, 0.0), 128.0, 0.0),
				  glm::highp_dvec3(-2.5, -0.2, 100.0), 1);
	Sphere secSpher(new Phong(false, glm::highp_dvec3(0.2f, 0.0f, 0.0f), glm::highp_dvec3(0.0f, 0.5f, 0.392f), 128.0f, 0.0f),
					glm::highp_dvec3(2.5f, -1.7f, 100.0f), 1);
	/*Triangle triangle(new Phong(false, glm::highp_dvec3(0.2f, 0.2f, 0.0f), glm::highp_dvec3(0.4f, 0.3f, 0.3f), 128.0f, 0.25f),
					  glm::highp_dvec3(1.7f, -2.0f, 100.0f),
					  glm::highp_dvec3(-2.7f, -2.0f, 100.0f), glm::highp_dvec3(-0.7f, 3.0f, 100.0f));*/
	Plan background(new Phong(false, glm::highp_dvec3(0.f, 0.f, 0.f), glm::highp_dvec3(0.3f, 0.3f, 0.3f), 128.0f, 0.0f),
					glm::highp_dvec3(0.0f, 0.0f, 200.0f),
					glm::highp_dvec3(0.0f, 0.0f, -1.0f));
	Plan rooftop(new Phong(false, glm::highp_dvec3(0.2f, 0.2f, 0.0f), glm::highp_dvec3(0.5f, 0.0f, 0.5f), 128.f, 0.0f),
				 glm::highp_dvec3(0.0f, 10.0f, 0.0f),
				 glm::highp_dvec3(0.0f, -1.0f, 0.0f));
	Plan left(new Phong(false, glm::highp_dvec3(0.2f, 0.0f, 0.2f), glm::highp_dvec3(0.0f, 0.6f, 0.0f), 128.f, 0.0f),
			  glm::highp_dvec3(10.0f, 0.0f, 0.0f),
			  glm::highp_dvec3(-1.0f, 0.0f, 0.0f));
	Plan right(new Phong(false, glm::highp_dvec3(0.0f, 0.2f, 0.2f), glm::highp_dvec3(0.6f, 0.0f, 0.0f), 128.0f, 0.0f),
			   glm::highp_dvec3(-10.0f, 0.0f, 0.0f),
			   glm::highp_dvec3(1.0f, 0.0f, 0.0f));
	Plan floor(new Phong(false, glm::highp_dvec3(0.2f, 0.2f, 0.2f), glm::highp_dvec3(0.2f, 0.0f, 0.5f), 128.f, 0.f),
			   ...
			   glm::highp_dvec3(0.0f, 1.0f, 0.0f));
	Plan closedBox(
			new Phong(false, glm::highp_dvec3(0.0f, 0.0f, 0.0f), glm::highp_dvec3(0.3f, 0.3f, 0.3f), 128.0f, 1.0f),
			glm::highp_dvec3(0.0f, 0.0f, -10.0f),
			glm::highp_dvec3(0.0f, 0.0f, 0.0f));
